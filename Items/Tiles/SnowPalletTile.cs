...
{
	public class SnowPalletTile : ModTile
	{
		public override void SetStaticDefaults()
        {
            ...
            name.SetDefault("Pallet of Snow");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			object p = Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 16, ItemType<Items.Placeable.SnowPallet>()); 
		}
	}
}