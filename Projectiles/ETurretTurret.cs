...
{
	public abstract class EBaseTurret : ModProjectile
	{
	...
	public class ETurretTurret : BaseTurret
	{
		public override void SetDefaults()
		{
			base.SetDefaults();
			...
			fireRate = 40;
			maxRange = 550f;
			turretBase = $"{nameof(CaffinatedMod)}/Projectiles/ETurretBase";
			baseOffset.Y = 14;
		...
		public override void Fire(EntitySource_ItemUse_WithAmmo source, Vector2 vector2, int target)
		{
			...
			Projectile.NewProjectile(source, center, velocity, ProjectileID.Flames, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
		}
	...
	*/
    public class ETurretItem : ModItem
    {
        public override string Texture => Mod.Name + "/Projectiles/ETurretTurret2";
		int yPlace = -51;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Flamethrower Turret Remote");
			Tooltip.SetDefault("Summons a flamethrower turret that scorches enemies");
        ...
        public override void SetDefaults()
        {
			...
			Item.shoot = Mod.Find<ModProjectile>("ETurretTurret").Type;
        }
