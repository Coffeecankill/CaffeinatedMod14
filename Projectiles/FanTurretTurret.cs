...
{
	public abstract class FanBaseTurret : ModProjectile
	{
	...
	public class FanTurretTurret : BaseTurret
	{
		public override void SetDefaults()
		{
			base.SetDefaults();
			...
			fireRate = 40;
			maxRange = 550f;
			turretBase = $"{nameof(CaffinatedMod)}/Projectiles/FanTurretBase";
			baseOffset.Y = 44;
		...
		public override void Fire(EntitySource_ItemUse_WithAmmo source, Vector2 vector2, int target)
		{
			...
			Projectile.NewProjectile(source, center, velocity, Mod.Find<ModProjectile>("FanShot").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
		}
	...
	/*
	public class ETurretTurretProj : ModProjectile
    {
	...
	*/
	public class FanTurretItem : ModItem
    {
        public override string Texture => Mod.Name + "/Projectiles/FanTurretTurret2";
		int yPlace = -51;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Lil' Whistler Remote");
			Tooltip.SetDefault("Summons a turbine turret that pushes enemies away");
        ...
        public override void SetDefaults()
        {
			...
			Item.shoot = Mod.Find<ModProjectile>("FanTurretTurret").Type;
        }
