...
{
	public abstract class BaseTurret : ModProjectile
	{
	...
	public class MGTurretTurret : BaseTurret
	{
		public override void SetDefaults()
		{
			base.SetDefaults();
			...
			fireRate = 12;
			maxRange = 900f;
			turretBase = $"{nameof(CaffinatedMod)}/Projectiles/MGTurretBase";
			baseOffset.Y = 46;
		...
		public override void Fire(EntitySource_ItemUse_WithAmmo source, Vector2 vector2, int target)
		{
			...
			Projectile.NewProjectile(source, center, velocity, Mod.Find<ModProjectile>("MGTurretTurretProj").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
	...
	public class MGTurretTurretProj : ModProjectile
    {
        public override string Texture
        {
            get
            {
                return "Terraria/Images/Projectile_14";
            }
        }
    ...
    public class MGTurretItem : ModItem
    {
        public override string Texture => Mod.Name + "/Projectiles/MGTurretTurret2";
		int yPlace = -51;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Machine Gun Turret Remote");
			Tooltip.SetDefault("Summons a machine gun turret that attacks enemies\n'Lil' Betty; cheap and reliable!'");
        ...
        public override void SetDefaults()
        {
			...
			Item.shoot = Mod.Find<ModProjectile>("MGTurretTurret").Type;
        }
