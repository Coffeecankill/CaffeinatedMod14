...
{
	public abstract class V2BaseTurret : ModProjectile
	{
	...
	public class V2TurretTurret : BaseTurret
	{
		public override void SetDefaults()
		{
			base.SetDefaults();
			...
			fireRate = 12;
			maxRange = 1200f;
			turretBase = $"{nameof(CaffinatedMod)}/Projectiles/V2TurretBase";
			baseOffset.Y = 46;
		...
		public override void Fire(EntitySource_ItemUse_WithAmmo source, Vector2 vector2, int target)
		{
			...
			Projectile.NewProjectile(source, center, velocity, Mod.Find<ModProjectile>("V2TurretTurretProj").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
	...
	public class V2TurretTurretProj : ModProjectile
    {
        public override string Texture
        {
            get
            {
                return "Terraria/Images/Projectile_88";
            }
        }
    ...
    public class V2TurretItem : ModItem
    {
        public override string Texture => Mod.Name + "/Projectiles/V2TurretTurret2";
		int yPlace = -51;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Laser Turret Remote");
			Tooltip.SetDefault("Summons a laser turret that attacks enemies\n'Lil' Bertha; angry and determined.'");
        ...
        public override void SetDefaults()
        {
			...
			Item.shoot = Mod.Find<ModProjectile>("V2TurretTurret").Type;
        }
